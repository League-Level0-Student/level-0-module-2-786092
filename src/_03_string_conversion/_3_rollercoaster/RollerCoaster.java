...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		public static void main(String[] agrs) {
			...
			String inches = JOptionPane.showInputDialog("Enter your height in inches: ");
			// Uncomment the line below...
			int heightAsInt = Integer.parseInt(inches);	
			if( heightAsInt >= 48 ) { 
				JOptionPane.showMessageDialog(null, "Hurray! You are tall enough to ride the coaster alone or you can ride the coaster with someone else!");
			}
